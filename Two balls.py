...
class Ball(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if pygame.sprite.spritecollideany(self, vertical_borders):
            self.vx = -self.vx
        if pygame.sprite.groupcollide(number1, number2, False, False):
...
Ball1 = Ball(100, 100, number1)
Ball2 = Ball(150, 150, number2)
...
while running:
    ...
    if (Ball1.rect.x - Ball2.rect.x) ** 2 + (Ball1.rect.y - Ball2.rect.y) ** 2 <= 25 ** 2:
